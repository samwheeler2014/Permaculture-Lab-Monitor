...
public class PhActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        phgraph = new Graph(((int) dq.getLowValue()), ((int) dq.getHighValue()), dq.getFrom().getNanos(),
                dq.getTo().getNanos(), ((int) (dq.getHighValue() - dq.getLowValue())),
                ((int) (dq.getFrom().getNanos() - dq.getTo().getNanos())), phra.getList());
        GraphView phGraph = (GraphView) findViewById(R.id.phgraph);
